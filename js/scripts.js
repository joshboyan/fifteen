...
function indexedDB() {
    ...
    var dbPromise = idb.open('scores', 1, function (upgradeDB) {
        ...
        var scores = upgradeDB.createObjectStore('scores', { keyPath: "key", autoIncrement:true });
    ...
    var dbPromiseOffline = idb.open('offline', 1, function (upgradeDB) {
        // Create object store in the database
        var offline = upgradeDB.createObjectStore('offline', { keyPath: "key", autoIncrement:true });
    }).then(function (db) {
...
function mongo() {
    ...
    fetch('/api/scores').then(function (rankings) {
        ...
        idb.open('scores', 1).then(function (db) {
          ...
          if(typeof indexedDBBackup == Array) {
...
}).call(this,require("e/U+97"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_9b9fa808.js","/")
},{"buffer":3,"e/U+97":6,"idb":4,"whatwg-fetch":7}],2:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":3,"e/U+97":6}],3:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/*!
...
},{"base64-js":2,"buffer":3,"e/U+97":6,"ieee754":5}],4:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
'use strict';
...
},{"buffer":3,"e/U+97":6}],5:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":3,"e/U+97":6}],6:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"buffer":3,"e/U+97":6}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
(function(self) {
  'use strict';
